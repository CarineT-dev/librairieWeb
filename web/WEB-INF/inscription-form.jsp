    ...
    <body>
        ...
        <form action="inscription" method ="POST">
            <div class="form-group">
                ...
                <input type="text" name="nom"  value =' <c:out value= "${requestScope.nom}" />' class="form-control" placeholder="Entrer votre nom" id="id-nom">
            </div>

            <div class="form-group">
                <label for="id-prenom">Prénom :</label>
                <input type="text" name="prenom" value =' <c:out value= "${requestScope.prenom}" />' class="form-control" placeholder="Entrer votre prénom" id="id-prenom">
            </div>

            <div class="form-group">
                <label for="email">Email  :</label>
                <input type="email" name="email" value =' <c:out value= "${requestScope.email}" />' class="form-control" placeholder="Entrez votre adresse email" id="email">
